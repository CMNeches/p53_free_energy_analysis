...
#load in the data
germline = pd.read_csv("../data/tissue_hotspots_germline.tsv", sep = '\t')
...
germline["Possible_Mutations"] = possible_muts_column
germline["Free_Energy_(kcal/mol)"] = possible_free_energies_column
germline["MSA_Name"] = possible_msa_column
germline.to_csv("../outputs/updated_germline.tsv", sep = '\t')
